...
void Carte::flip(DemiCote *d)
{
    Debugge(d->coordonnees(), d->oppose()->coordonnees());
    //coté
    if (d->d_sommet->demiCote() == d) {
        d->d_sommet->d_demiCote = d->suivant();
    }
    ...
    //coté opposé
    if (d->oppose()->d_sommet->demiCote() == d->oppose()) {
        d->oppose()->d_sommet->d_demiCote = d->oppose()->suivant();
    }

    d->oppose()->suivant()->d_precedent = d->oppose()->precedent();
    d->oppose()->precedent()->d_suivant = d->oppose()->suivant();

    d->oppose()->d_precedent = d->oppose()->suivant()->oppose();
    d->oppose()->d_suivant = d->oppose()->suivant()->oppose()->suivant();

    d->oppose()->suivant()->d_precedent = d->oppose();
    d->oppose()->precedent()->d_suivant = d->oppose();

    d->oppose()->d_sommet = d->oppose()->suivant()->oppose()->sommet();
